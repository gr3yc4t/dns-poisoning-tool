...
##  @name get_id
#   This function listen for incoming data on the specified port 
#   @param udp_ip The IP where the UDP server should bind
#   @param The port where the UDP server should bind
